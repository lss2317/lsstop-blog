...
public class FileController {
    ...
    @OperationLog(module = OperationModuleEnum.FILE, type = OperationTypeEnum.UPLOAD, description = "上传聊天室图片")
     ...
     * @return 头像访问URL
     */
    @PostMapping("/admin/file/avatar")
    @AccessLimit(seconds = 60, maxCount = 30)
    @OperationLog(module = OperationModuleEnum.FILE, type = OperationTypeEnum.UPLOAD, description = "上传用户头像")
